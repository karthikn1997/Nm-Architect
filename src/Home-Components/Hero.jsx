...
const Hero = () => {
  ...
  return (
    <div className='w-full min-h-screen lg:-mt-40'>
      <section className="relative min-h-[100vh] w-full flex flex-col items-center justify-center hero-section gap-8 lg:gap-4 py-8 overflow-hidden">
        ...
        <div className='relative w-full mx-auto min-h-[100vh] p-6 sm:px-8 pt-10 lg:pt-[200px] flex flex-col justify-center items-center z-10'>
          <h1 className="text-2xl sm:text-3xl lg:text-5xl text-[#fae4af] font-light mb-4 text-center lg:text-left italic " data-aos="slide-right" data-aos-delay="300" style={{fontFamily: "Rolland" , textShadow: "2px 2px 0px black"}}>
            <Typewriter
              words={[
