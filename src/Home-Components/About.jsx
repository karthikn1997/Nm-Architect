...
import Image1 from '../assets/md8.png';
import Image2 from '../assets/md6.png';
            ...
            <div className='w-[90%] mx-auto flex flex-col items-center'>
                <div className='w-full text-center lg:text-left' data-aos="fade-up" data-aos-delay="300">
                    <h1 className='text-3xl lg:text-4xl font-bold text-white mb-6'>
                        About <span className='text-gray-300'>Nm Square Architecture</span>
                    </h1>
                    <div className='text-base lg:text-lg text-gray-400 leading-7 mb-4'>
                        <p className='mb-4'>
                            Nm Square Architecture is a premier real estate company committed to helping individuals and families find their dream properties. We provide exceptional service and unmatched expertise in the local real estate market, offering a wide range of properties to meet your needs.
                        </p>
                    </div>
                </div>
                {/* Image Row */}
                <div className='w-full flex flex-col lg:flex-row justify-center items-center mb-10 py-4' data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div className='w-full lg:w-1/2 relative border-gray-300 py-4 px-2 border-opacity-50 shadow-lg'>
                        <img
                            src={Image1}
                            alt="Real Estate"
                    ...
                    <div className='flex flex-col items-center mx-6 lg:mx-8'>
                        ...
                        <div className='hidden md:block relative'>
                            <div className='w-16 h-16 flex items-center justify-center rounded-full bg-gray-300 text-[#26282B] text-2xl shadow-md'>
                        ...
                        <div className='h-[200px] w-[2px] bg-dotted bg-gray-300 opacity-70 mt-4'></div>
                    </div>
                ...
                <div className='text-base lg:text-lg text-gray-400 leading-7 mb-4' data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p>
                        Join us at Nm Square Architecture and turn your real estate dreams into reality.
                    </p>
                </div>
