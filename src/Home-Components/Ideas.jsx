    ...
    return (
        <div className='relative w-full min-h-[60vh] -mt-10'>
            ...
            <div className="w-full sm:w-[95%] mx-auto relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 p-4 sm:p-8 gap-4 sm:gap-10 my-10 text-justify lg:text-left z-50">
                <div className='h-full p-8 border-l border-t border-gold border-opacity-50 '>
                    <PiLightbulbFilamentLight className='text-5xl sm:text-7xl text-white mb-4 border-2 p-3 rounded-full border-gold border-opacity-50 ' />
                ...
                <div className='h-full p-8'>
                    <SiAltiumdesigner className='text-5xl sm:text-7xl text-white mb-4 border-2 p-3 rounded-full border-gold border-opacity-50' />
                ...
                <div className='h-full p-8'>
                    <CgLoadbarSound className='text-5xl sm:text-7xl text-white mb-4 border-2 p-2 rounded-full border-gold border-opacity-50' />
                ...
                <div className='h-full p-8 border-r border-b border-gold border-opacity-50'>
                    <IoCheckmarkDone className='text-5xl sm:text-7xl text-white mb-4 border-2 p-3 rounded-full border-gold border-opacity-50' />
