...
const Ideas = () => {
    return (
        <>
            <div className='relative w-full min-h-[60vh] -mt-10 mb-10'>
                ...
                <div className="w-full sm:w-[95%] mx-auto relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 p-4 sm:p-6 gap-2 my-10 text-justify lg:text-left z-50 leading-6">
                    <div className='h-full p-8 py-14 border-l border-t border-gold  '>
                    ...
                    <div className='h-full p-8 py-14'>
                    ...
                    <div className='h-full p-8 py-14 border-r border-b border-gold '>
