            ...
            <div className='relative w-full min-h-[60vh] -mt-10'>
                ...
                <div className="w-full sm:w-[95%] mx-auto relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 p-4 sm:p-8 gap-4 sm:gap-10 my-10 text-justify lg:text-left z-50">
                    <div className='h-full p-8 border-l border-t border-gold  '>
                        ...
                        <h3 className='text-2xl font-light text-white tracking-wider mb-2 sm:mb-4' style={{ fontFamily: "Orbitron" }}>Creative Ideas</h3>
                    ...
                    <div className='h-full p-8'>
                        ...
                        <h3 className='text-2xl font-light text-white tracking-wider mb-2 sm:mb-4 ' style={{ fontFamily: "Orbitron" }}>Uniqueness</h3>
                        <p className='text-md text-gray-300 tracking-wider font-light '>
                    ...
                    <div className='h-full p-8'>
                        ...
                        <h3 className='text-2xl font-light text-white tracking-wider mb-2 sm:mb-4' style={{ fontFamily: "Orbitron" }}>High Efficiency</h3>
                        <p className='text-md text-gray-300 tracking-wider font-light '>
                    ...
                    <div className='h-full p-8 border-r border-b border-gold '>
                        ...
                        <h3 className='text-2xl font-light text-white tracking-wider mb-2 sm:mb-4' style={{ fontFamily: "Orbitron" }}>Best Solution</h3>
                        <p className='text-md text-gray-300 tracking-wider font-light '>
