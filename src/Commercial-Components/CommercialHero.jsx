        ...
        <div className='w-full min-h-screen -mt-40'>
            <section className="relative min-h-[100vh] w-full flex flex-col items-center justify-center hero-section gap-8 lg:gap-4 py-8 overflow-hidden">
                ...
                <div className='relative text-white text-center '>
                    <h2 className='text-6xl uppercase tracking-widest text-gold px-4 py-2' style={{ fontFamily: "Rolland", textShadow: "1px 1px 0px gray" }}><span className="text-white" >Commercial</span> <span style={{ textShadow: "1px 1px 0px #fae4af" }}>Projects</span></h2>
                </div>
