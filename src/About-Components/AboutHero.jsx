        ...
        <div className='w-full min-h-[50vh] sm:min-h-[100vh] sm:-mt-40'>
            <section className="relative min-h-[50vh] sm:min-h-[100vh] w-full flex flex-col items-center justify-center hero-section gap-8 lg:gap-4 py-8 overflow-hidden">
                ...
                <div className='text-white text-center'>
                    <p className='text-xl text-gold uppercase mb-3 sm:mb-6'>Who We Are ?</p>
                    <h2 className='text-3xl sm:text-4xl lg:text-6xl tracking-widest text-[#fae4af] uppercase' style={{ fontFamily: "Cr" }}><span className="text-white uppercase" style={{ fontFamily: "Cr" }}>NM Square</span> Architecture</h2>
                </div>
