...
import info from "../assets/bg.png"
...
const AboutInfo = () => {
    return (
        <div className='w-full min-h-screen py-10'>
            ...
            <div className='relative w-[80%] mx-auto flex flex-col lg:flex-row justify-center items-center overflow-hidden gap-10 mb-10'>
            ...
            <div className='w-[80%] mx-auto flex justify-center items-center'>
                ...
                <div className='w-[50%] flex justify-end items-start'>
                    <img src={info} alt="" className='w-full rounded-md opacity-60' />
                </div>
            </div>
